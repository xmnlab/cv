...
\cventry{2011--2013}{Software Developer}{Cetil Sistemas de Informática S/A, CETIL}{Florianópolis/Brazil}{Full-time}{Analysis and development of management systems for public administration, such as document and process procedures, legal text, legislative procedures, municipal problems records, and municipal transparency portal. Use of technologies: .NET, VB, SQL Server, Kettle. Also, acted as Function Points accountant and reviewer.}

\cventry{2011--2011}{Software Developer}{Victory Consulting (VICTORY)}{São Paulo/Brazil}{Full-time}{
Development of tools for the management of health insurance and life quality program. Use of diverse technologies, such as PHP, JavaScript, jQuery, PHP Unit, Yii Framework, etc.}

\cventry{2007--2009}{Software Developer}{Prefeitura Municipal de Guarulhos (PMG)}{Guarulhos/Brazil}{Full-time}{
...
\cventry{2006--2007}{Teacher}{Centro de Assistência e Promoção Social Nosso Lar (NOSSO LAR)}{Guarulhos/Brazil}{Contract}{Teacher in a technical informatic course.}

\cventry{2006--2007}{Software Developer}{Uacari Consultoria de Informática (UACARI)}{Guarulhos/Brazil}{Contract}{Software developement using technologies such as PHP, and Java, and Linux Server administration tasks.}

\cventry{2005--2005}{Instructor}{Colégio e Faculdade ENIAC (ENIAC)}{Guarulhos/Brazil}{Contract}{Substitute teacher in undergraduate technology disciplines. Teacher in practical classes in a technical informatic course.}

\cventry{2005--2005}{Software Developer}{Vemac Comércio e Serviços LTDA - ME (VEMAC)}{São Paulo/Brazil}{Full-time}{Analysis and development of systems for basic health units.}

\cventry{2002--2004}{Software Developer}{Colégio Eniac (ENIAC)}{Guarulhos/Brazil}{Full-time}{Development of systems and WEB sites for school management. Use of technologies such as PHP, Java, Javascript, Flash, MySQL, Linux server, etc.}

\cventry{2002--2002}{Software Developer}{QualityWay (QUALITY WAY)}{São Paulo/Brazil}{Full-time}{Development of internal system. Use of technologies such as VB6 and MS Access.}

\section{Volunteer Experience}

\cventry{2020--Present}{Software Reviewer, Review Editor}{PyOpenSci}{}{}{At PyOpenSci, I have acted as a software package reviewer, review editor, and recently I am acting also as a member of the editorial board.}
