...
% personal data
\name{Ivan}{Ogasawara}
\title{Senior Open Source Developer and Research Software Engineer}                               % optional, remove / comment the line if not wanted
