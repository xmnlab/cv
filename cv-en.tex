...
\section{Summary}
\cventry{}{Having worked as a developer for more than 20 years, I am passionate about exploring topics such as Compilers, Data Science and Open Science. I have some knowledge in a variety of programming languages such as Python, C++, JavaScript, PHP, VB, JAVA, Rust, ShellScript, etc used for back-end, front-end, DevOps, and packaging. I had the chance to contribute to a few scientific projects as a Research Software Engineer (RSE) for Transportation Engineering and Public Health. I've contributed to open source projects such as PyTorch, ibis-framework, and the Jupyter ecosystem, and I've created and been maintained some tools that helps to improve the development workflow such as MakIm, and Containers-Sugar. Currently, I am also creating a compiler using LLVM (initially based on Kaleidoscope LLVM tutorial). Some of the libraries and tools I've been using in the last years are: LLVM, ibis-framework, pandas, PostgreSQL, Django, Django-rest framework, flask, GraphQL, Vue.js, JQuery, conda, Docker, mkdocs, makim, sugar, and others. As an Open Science enthusiast, I've also contributed to PyOpenSci as a package reviewer, review editor, and advisor, and I am leading a community called Open Science Labs, that aims to create an open and safe space for learning, teaching and sharing knowledge, besides generating oportunities among the community and projects affiliated.}{}{}{}{}{}
...
\cventry{2023--Present}{Research Software Engineer}{The GRAPH Network/LiteRev}{Part-time}{}{In the LiteRev project, I've been acting as a Tech and Team Leader, Software Architect, and DevOps engineer.}

\cventry{2022--2023}{Research Software Engineer}{The GRAPH Network}{Part-time}{}{As a server administrator, I am responsible for ensuring the servers are operating efficiently and implementing new services for internal usage. Additionally, I provide internal training to the team on topics such as git, Python tools, and best practices. I am also responsible for defining and implementing best practices for open source projects and designing the architecture for new implementations. My expertise includes working with technologies such as Python, R, CI/CD, Docker, PostgreSQL, Ansible, Nginx, Apache Superset, and packaging with conda. Currently, I am also leading a small team for a private project.}

\cventry{2022--2023}{Software Developer}{Inlyse}{Part-time}{}{I've acted as a project leader of a homemade platform for customers where they can manage their license keys (for Inlyse products) and manage their payments through stripe integration.
Currently, I am working on some tools for feeding the internal pipeline for ML training models. Some of the technologies used: Python, C++, Bash, JavaScript, Ansible, Django, Docker, CI/CD, Stripe, etc.}
...
\cventry{2015--Present}{Founder, Executive Director}{Open Science Labs}{}{}{At Open Science Labs, my main tasks are to define guidance to the project in all the areas, such as: digital marketing, devops, mentoring program, training program, community management, etc. Also, I have acted in different areas such as devops, community management, content creation, and mentoring.}

\cventry{2020--2023}{Software Reviewer, Review Editor}{PyOpenSci}{}{}{Acted as a software package reviewer, review editor, and recently I am a member of the editorial board.}
