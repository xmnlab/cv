...
\cventry{2018--}{Desarrollador}{Quansight}{}{}{Actuación en el desarrollo de nuevas funcionalidades y correción de fallas, creación de documentación y paquetes de instalación de librería open source. Utilización y desarrollo con/de tecnologías como: Python, Conda, C++, Sphinx, JupyterLab, MapD, Ibis-project, Django, Django-Rest-Framework, GraphQL, Docker, Vue.js, React.js}
...
\item Desarrollo de la librería SciKit-Data. Su proposito es reducir el código repetitivo, reducir el tiempo dedicado a las tareas de análisis de datos y ofrecer un flujo de trabajo de análisis de datos reproducible (\url{github.com/OpenDataScienceLab/skdata}).
\end{itemize}}
